  ...
  return (
    <div className="text-left">
      ...
      {items.length === 0 ? (
        ...
        <PageError
          message={
            productsErrorDetail?.isNetworkError
              ? "Cannot reach the server. Please check your connection and try again."
              : "Could not load product details. Refresh the page or try again shortly."
          }
        />
      ) : (
      ...
      {/* Mobile fixed checkout bar (visible on small screens) */}
      {items.length > 0 && !productsLoading && !productsError && (
        <div className="lg:hidden fixed left-0 right-0 bottom-4 z-50 px-4">
          <div className="mx-auto max-w-4xl">
            <div className="card p-4 shadow-lg">
              ...
              <div className="mt-3">
                ...
                <Show when="signed-out">
                  <SignInButton mode="modal">
                    <button type="button" className="btn btn-outline btn-primary w-full">
                      <LogInIcon className="size-4" aria-hidden />
                      Sign in to checkout
                    </button>
                  </SignInButton>
